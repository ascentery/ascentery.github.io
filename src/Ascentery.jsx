...
function TopBar({ me, view, go }) {
  ...
  // Clamped to 1 — credits can genuinely exceed creditCap after a large
  // top-up, and an unclamped fraction here doesn't just look wrong, it
  // makes the inner bar's own width percentage exceed its parent's
  // width, visibly overflowing the fixed-width container to the right.
  const frac = me.creditCap ? Math.min(1, me.credits / me.creditCap) : 0;
  return (
